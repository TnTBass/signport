...
public final class BlueMapBridge {
    ...
    private static final Consumer<BlueMapAPI> ENABLE_LISTENER = BlueMapBridge::onEnable;
    private static final Consumer<BlueMapAPI> DISABLE_LISTENER = BlueMapBridge::onDisable;
    ...
    public static void serverStarted(MinecraftServer server) {
        BlueMapBridge.server = server;
        reconcileAll();
    }

    public static void serverStopping(MinecraftServer server) {
        if (BlueMapBridge.server == server) {
            BlueMapBridge.server = null;
        }
    }
