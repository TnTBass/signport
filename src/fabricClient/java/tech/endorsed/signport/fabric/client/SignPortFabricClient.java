package tech.endorsed.signport.fabric.client;
...
import tech.endorsed.signport.fabric.network.FabricPayloads;
...
public class SignPortFabricClient implements ClientModInitializer {
